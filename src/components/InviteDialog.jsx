  ...
  return (
    <DialogRoot>
      ...
      <DialogContent>
        ...
        <DialogBody>
          <p>
            Simply share this link with others to invite them to collaborate on
            this document. Everybody with the link will be able to view and edit
            the document.
          </p>
        </DialogBody>
        <DialogFooter>
